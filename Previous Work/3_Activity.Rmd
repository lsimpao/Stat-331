...
name <- c("George Orwell", "Mei Lin", "Franz Gersheim")
prim_lang <- c("English", "Chinese", "German")
greeting <- c("Hello", "Ni Hao", "Guten Tag")
greet_lang <- data.frame(prim_lang, greeting)
subscriber <- data.frame(name, prim_lang)
```
...
test2 <- c(9,11,13,25,27,29,31,33,35)
every_other(test2, 1)
every_other(test2, 2)
